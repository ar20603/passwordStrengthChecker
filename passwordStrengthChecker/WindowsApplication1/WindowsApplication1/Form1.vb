...
Public Class Form1
    ...
    Private Sub txtPassword_TextChanged(sender As Object, e As EventArgs) Handles textPassword.TextChanged, txtUsername.TextChanged
        ...
        Dim lines = My.Resources.words
        Dim words() As String = lines.Split(New Char() {" "c})
        ...
        While j < password.Length
            ...
            If num + 1 >= 2 Then
                ...
                password = password.Remove(j - num - 1, num)
            ElseIf num > 0 Then
                consecChars += (num + 1)
            End If
        End While
        ...
        Dim freqDict As New Dictionary(Of Char, Integer)
        For Each c In password
            If Not freqDict.ContainsKey(c) Then
                freqDict.Add(c, 1)
            Else
                freqDict(c) += 1
            End If
